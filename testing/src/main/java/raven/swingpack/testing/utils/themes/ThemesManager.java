package raven.swingpack.testing.utils.themes;
...
public class ThemesManager {
    ...
    void loadThemes() {
        ...
        try (Reader reader = new InputStreamReader(getClass().getResourceAsStream("/raven/swingpack/testing/themes/themes.json"), StandardCharsets.UTF_8)) {
